...
public class LarsTesto extends JFrame {
	...
	public static void main(String[] args) {
		...
		lt.jButtonDurchläufeErzeugen(0, 2);
		lt.jButtonDurchläufeErzeugen(1, 3);
		lt.jButtonDurchläufeErzeugen(10, 4);
		lt.jButtonDurchläufeErzeugen(100, 5);
		lt.jButtonDurchläufeErzeugen(1000, 6);
		lt.jButtonDurchläufeErzeugen(10000, 7);
		lt.jButtonDurchläufeErzeugen(100000, 8);
		lt.jButtonDurchläufeErzeugen(1000000, 9);
	...
	public void jButtonDurchläufeErzeugen(int durchläufe, int nrButton) {
		JButton b = new JButton();
		b.setBounds(900, 500 + nrButton * 25, 400, 25);
		b.setText("D" + durchläufe);
		b.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (durchläufe == 0) {
					...
					durchlauf = durchlauf + durchläufe;
